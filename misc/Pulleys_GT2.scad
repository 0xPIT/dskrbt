...
motor_shaft =8.9;	    // NEMA17 motor shaft exact diameter = 5
...
pulley_t_ht = 3.8;	// length of toothed part of pulley, standard = 12
...
{ 
  difference() {
    ...
    //translate([0, 0, 4.8]) cylinder(r=5.1, h=4, $fn=25, center=true);
  }
}
